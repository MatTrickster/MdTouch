...
"font: 75 20pt \"URW Bookman L\";")
    ...
    def retranslateUi(self, DispensaryMainWindow):
        ...
        self.filterComboBox.setItemText(1, _translate("DispensaryMainWindow", "Search By Name"))
        self.filterComboBox.setItemText(0, _translate("DispensaryMainWindow", "All medicines"))
        ...
        self.filterComboBox.setItemText(4, _translate("DispensaryMainWindow", "Sort by Mfd Date"))
        self.filterComboBox.setItemText(5, _translate("DispensaryMainWindow", "Sort by Expiry Date"))
        ...
        self.fillMedicine(DispensaryMainWindow)
    ...
    def events(self,DispensaryMainWindow):
        ...
        self.searchEventButton.clicked.connect(lambda : self.searchEventFunction(DispensaryMainWindow))

    # Event Add Functionality

    def fillMedicine(self,MainWindow):
        self.MedicineSearchTable.setRowCount(1000)

        MedicineID = list(range(5))

        for i in range(1000):
            self.MedicineSearchTable.setRowHeight(i,40)
            item1 = QTextBrowser()
            item1.setText("ID"+str(i))
            item1.setReadOnly(True)
            item1.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,0,item1)

            item2 = QTextBrowser()
            item2.setText("NAME"+str(i))
            item2.setReadOnly(True)
            item2.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,1,item2)

            item3 = QTextBrowser()
            item3.setText("PRICE"+str(i))
            item3.setReadOnly(True)
            item3.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,2,item3)

            item4 = QTextBrowser()
            item4.setText("QUANTITY"+str(i))
            item4.setReadOnly(True)
            item4.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,3,item4)

            item5 = QTextBrowser()
            item5.setText("BATCH"+str(i))
            item5.setReadOnly(True)
            item5.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,4,item5)

            item6 = QTextBrowser()
            item6.setText("MFD"+str(i))
            item6.setReadOnly(True)
            item6.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,5,item6)

            item7 = QTextBrowser()
            item7.setText("EXP"+str(i))
            item7.setReadOnly(True)
            item7.setAlignment(Qt.AlignCenter)
            self.MedicineSearchTable.setCellWidget(i,6,item7)
    ...
    def searchEventFunction(self, DispensaryMainWindow):
        self.window = QtWidgets.QDialog()
