...
class Ui_EventDialog(QWidget):
    def setupUi(self, EventDialog):
        ...
        EventDialog.setStyleSheet("background: rgb(66, 140, 244);")
        ...
        self.evenLabel.setStyleSheet("font: 75 18pt \"Tibetan Machine Uni\";text-decoration : underline;")
        ...
        self.titleInput.setStyleSheet("font: 75 16pt \"Ubuntu Condensed\";background : rgb(225,225,225);")
        ...
        self.imageFileInput.setStyleSheet("font: 75 16pt \"Ubuntu Condensed\";background : rgb(225,225,225);")
        ...
        self.placeInput.setStyleSheet("font: 75 16pt \"Ubuntu Condensed\"; background : rgb(225,225,225);")
